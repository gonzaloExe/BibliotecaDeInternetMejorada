...
<body>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item active submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Categoria</a>
              ...
              <li class="nav-item submenu dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Autor</a>
                <ul class="dropdown-menu">
          ...
          <div class="row s_product_inner">
            ...
            <div class="col-lg-5 offset-lg-1">
              <div class="s_product_text">
                ...
                <a class="button primary-btn" data-toggle="modal" data-target="#pdfModal" data-pdf="<?php echo $row['link']; ?>">Previsualizar</a>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pdfModalLabel">Previsualización del PDF</h5>
  ...
  $('#pdfModal').on('show.bs.modal', function(event) {
    var pdfFileName = $(event.relatedTarget).data('pdf');
    var pdfPath = 'assets/img/descargas/' + pdfFileName;
    var iframeElement = document.getElementById('pdfIframe');
    iframeElement.src = pdfPath;
  });
</script>
